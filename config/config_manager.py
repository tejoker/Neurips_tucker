#!/usr/bin/env python3
"""
Configuration Management System for Tucker-CAM Industrial Time Series Analysis
...
1. Environment variables (TUCKER_CAM_*)
...
class ConfigManager:
    """Centralized configuration manager for Tucker-CAM platform"""

    def __init__(self, config_dir: Optional[Path] = None, environment_prefix: str = "TUCKER_CAM"):
        """
        Initialize configuration manager

        Args:
            config_dir: Directory containing configuration files (default: ./config)
            environment_prefix: Prefix for environment variables (default: TUCKER_CAM)
        """
    ...
    def _apply_environment_overrides(self):
        ...
        for env_var, value in os.environ.items():
            if env_var.startswith(env_prefix):
                # Convert TUCKER_CAM_SYSTEM_GPU_ENABLED -> system.gpu_enabled
...
class SystemConfig:
    ...
    temp_dir: str = "/tmp/tuckercam"
    log_level: str = "INFO"
    log_file: str = "logs/tuckercam.log"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Tucker-CAM Configuration Manager")
