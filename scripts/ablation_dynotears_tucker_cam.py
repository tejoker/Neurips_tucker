...
class TuckerFastCAMDAG:
    ...
    def __init__(
        ...
        disable_tucker: bool = False,
        disable_smoothness: bool = False,
        disable_core_sparsity: bool = False,
        disable_orthogonality: bool = False,
        device='cuda'
    ):
        """
        ...
        self.disable_tucker = disable_tucker
        self.disable_smoothness = disable_smoothness
        self.disable_core_sparsity = disable_core_sparsity
        self.disable_orthogonality = disable_orthogonality
        self.device = device
    ...
    def fit(
        ...
        if self.model is None:
            ...
            self.model = TuckerCAMModel(
                ...
                disable_tucker=self.disable_tucker,
                disable_smoothness=self.disable_smoothness,
                disable_core_sparsity=self.disable_core_sparsity,
                disable_orthogonality=self.disable_orthogonality,
                device=self.device
            )
